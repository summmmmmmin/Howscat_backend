...
Howscat Android 앱의 전용 백엔드. JWT 인증, Gemini AI 연동, 고양이별 건강 기록 관리, 주변 병원 검색(Kakao Local 프록시), AWS S3 이미지 업로드를 담당한다.
...
<img width="1106" height="801" alt="image" src="https://github.com/user-attachments/assets/de0d8b4a-a107-4caa-9b94-6c207e058d1c" />
...
### 요구사항
- JDK 17
- MySQL 8.x (로컬) 또는 AWS RDS / EC2 DB 연결
